<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}"
            target="_blank">
            <span class="ms-1 font-weight-bold">Safe School System</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        ...
        @if(Auth::user()->role == 2)  
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="{{ route('admins-management') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Administrators Management</span>
                </a>
            </li> -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('teachers-management') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Teachers Management</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('parents-management') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Parents Management</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('students-management') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('notice-view-admin') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Parent Notice</span>
                </a>
            </li>
            @else
            <li class="nav-item mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('notice-view') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Notice of Absence</span>
                </a>
            </li>
            @endif
            <!-- <li class="nav-item">
